...
public class DoubleLinkedList<T> extends Collections<T> {
	...
	// The `public DoubleLinkedList()` constructor initializes a new instance of the
	// `DoubleLinkedList`
	// class. It sets the `first` and `last` pointers to `null`, indicating that the
	// list is empty. It
	// also sets the `numItems` variable to 0, indicating that there are no items in
	// the list.
	...
	/**
	 * The addFirst function adds a new node containing the given value to the
	 * beginning of a doubly
	 * linked list.
	 * 
	 * @param n The parameter "n" is of type T, which means it can be any data type.
	 *          It represents the
	...
	/**
	 * The function searches for a specific object in a doubly linked list and
	 * returns the object if
	 * found, otherwise it returns null.
	 * 
	 * @param clave The parameter "clave" is the key or value that we are searching
	 *              for in the list.
	 * @return The method is returning the object that matches the given key
	 *         (clave). If no match is
	 ...
	 * 
	 * @param n The parameter `n` is of type `Object` and represents the element to
	 ...
	 * 
	 * @param index The index parameter represents the position of the node that we
	...
	/**
	 * The function sets the content of a node at a given index in a linked list to
	 * a specified object.
	 * 
	 * @param index  The index parameter represents the position at which the object
	 *               should be set in the
	 *               data structure.
	 * @param object The object parameter is the new value that you want to set at
	...
	/**
	 * The function checks if the number of items is zero and returns true if it is,
	 * indicating that the
	 * collection is empty.
	 * 
	 * @return The method is returning a boolean value, which indicates whether the
	 *         collection is empty or
	 *         not. If the number of items in the collection is 0, then the method
	 *         will return true, indicating
	 *         that the collection is empty. Otherwise, it will return false,
	 *         indicating that the collection is
	 *         not empty.
	 */
	@Override
	...
	/**
	 * The function removes an element at a specified index from a list and returns
	...
	/**
	 * The function "showAll" returns a string representation of all the elements in
	 * a linked list.
	 * 
